...
public class DBApp {
	...
	public static void main(String[] args) throws DBAppException, IOException, ParseException, ClassNotFoundException {
		...
		// createTable(tableName, "id", htblColNameType);
		...
		// double x = (n * 2.0 * y) / (random.nextInt(100) * 1.0);
		// htblColNameValue.put("id", new Integer(n));
		// htblColNameValue.put("gpa", new Double(x));
